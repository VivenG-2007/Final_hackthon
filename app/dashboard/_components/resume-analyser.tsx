...
export default function ResumeAnalyserSection() {
    ...
    return (
        <section className="rounded-[2rem] p-8 glass card-shadow border border-black/5 dark:border-white/10 hover:shadow-pink-500/5 transition-all duration-500" aria-labelledby="resume-analyser-heading">
            ...
            <div className="space-y-8">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    <div className="p-4 rounded-2xl bg-black/[0.02] dark:bg-white/5 border border-black/5 dark:border-white/5 hover:bg-black/[0.04] dark:hover:bg-white/10 transition-colors">
